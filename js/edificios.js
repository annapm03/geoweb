function addEdificiosCapa() {
    ...
    map.addSource("edificios_source", {
        "type": "vector",
        "url": "mapbox://annapm03.5dahgfbf"  // mapbox://Nuestor ID Tileset
    ...
    "source-layer": "construcciones-bugdsk", // Nuestro nombre Tileset
    "maxzoom": 21,
    "minzoom": 15,
    "filter": [">", "numberOfFl", 0],
    "paint": {
...
,"road-label"// y el nombre de las calles ya quedan por encima
);  
